...
#                                                                           #
# Script:  regressions_prop_products_model_IDN.R                            #
#                                                                           #                                                                      #
#                                                                           #                                                                                                                                                             #
#===========================================================================#
...
models_definitive_IDN_t_2 <- prop_reg_models_definitive("pay_or_ecomnod_t_2", 
                                                        coef_labels = coef_labels, 
                                                        country_name = "Indonesia")

# Regressions with 1 lag (t-1) in technology variable
models_definitive_IDN_t_1 <- prop_reg_models_definitive("pay_or_ecomnod_t_1", 
                                                        coef_labels = coef_labels, 
                                                        country_name = "Indonesia")


# Regressions with 3 lags (t-3) in technology variable
models_definitive_IDN_t_3 <- prop_reg_models_definitive("pay_or_ecomnod_t_3", 
                                                        coef_labels = coef_labels, 
                                                        country_name = "Indonesia")
