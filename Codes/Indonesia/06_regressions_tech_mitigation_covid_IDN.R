...
models_tech_covid_ebay_china_IDN<-reg_models_tech_covid_ebay_china(import_tech_mitig, 
                                                                   export_tech_mitig, 
                                                                   "Indonesia", 
                                                                   coef_labels)
...
models_tech_covid_BEC_IDN <- reg_models_tech_covid_BEC(import_tech_mitig, 
                                                       export_tech_mitig, 
                                                       "Indonesia", 
                                                       coef_labels)
...
models_covid_time_sensitivity_IDN<-reg_models_covid_time_sensitivity(import_tech_mitig, 
                                                                     export_tech_mitig, 
                                                                     "Indonesia", 
                                                                     coef_labels)
...
models_covid_prods_impacted_IDN<-reg_model_covid_prods_impacted(import_tech_mitig, 
                                                                export_tech_mitig, 
                                                                "Indonesia", 
                                                                coef_labels)
...
models_covid_prods_cap_int_IDN<-reg_model_covid_cap_int(import_tech_mitig, 
                                                        export_tech_mitig, 
                                                        "Indonesia", 
                                                        coef_labels)
