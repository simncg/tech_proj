...
models_ebay_china_IDN_t_1 <- reg_models_ebay_china(tech_var = "pay_or_ecomnod_t_1", 
                                                   import_data = paybustorecomimport_data_IDN,
                                                   export_data = paybustorecomexport_data_IDN, 
...
coef_labels<-c(pay_or_ecomnod="E-payment or E-commerce", 
               ...
               "pay_or_ecomnod_t_1:mean_IDN_remote_work_ISIC"="E-payment or E-commerce (t-1) × Mean Remote Work ISIC",
               "pay_or_ecomnod_t_2:mean_IDN_remote_work_ISIC"="E-payment or E-commerce (t-2) × Mean Remote Work ISIC",
               "pay_or_ecomnod_t_3:mean_IDN_remote_work_ISIC"="E-payment or E-commerce (t-3) × Mean Remote Work ISIC",
