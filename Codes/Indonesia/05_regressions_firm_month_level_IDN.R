...
# Imports data
import_data_IDN<-fread("../../Data/Indonesia/processed_data/imports_reg_firm_month_IDN.csv")

# Exports data 
export_data_IDN<-fread("../../Data/Indonesia/processed_data/exports_reg_firm_month_IDN.csv")
...
reg_firm_month_IDN <- reg_firm_month(tech_var  = "pay_or_ecomnod_t_2",
                                     import_data = import_data_IDN,
                                     export_data = export_data_IDN,
