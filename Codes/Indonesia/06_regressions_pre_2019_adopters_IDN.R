...
coef_labels<-c(
  ...
  "pre_2018_adopter:month_mean_stringency_index:durable_BEC" = "Pre-2018 Adopter × Monthly Avg. Stringency Index × Durable", 
...
pre_2019_adopters_reg_imp_exp_IDN<- reg_models_pre_2019_adopters(import_data = import_tech_mitig, 
...
pre_2019_adopters_reg_n_countries_IDN<- reg_models_pre_2019_adopters(import_data = import_tech_mitig, 
                                                                     export_data = export_tech_mitig, 
                                                                     country_name = "Indonesia", 
                                                                     product_vars = c("cons_BEC", 'China_E_commerce', "Ebay_tradable", "durable_BEC"), 
                                                                     coef_labels = coef_labels, 
