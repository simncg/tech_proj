...
load("../../Data/processed_data/quality_foreign_data.RData")
...
imp_quality_IDN %>% 
  ...
  column_to_rownames("year") %>% 
  # Create Table
  kable(caption = "Panjiva Imports Indonesia - Summary Statistics of Proportion of Firm Total Imports with Non-Missing Foreign Partners",
        booktabs = T, linesep = "", align = c("l",rep("c", 7))) %>% 
  kable_styling(latex_options = c("HOLD_position"))
