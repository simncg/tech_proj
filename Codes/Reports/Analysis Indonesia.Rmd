...
subtitle: "Regression Results for Indonesia"
...
\begin{equation}\label{reg_1}
    y_{ipt} = \alpha_0 + \alpha_1 tech_{i,t-l} \cdot category_{p} + \alpha_2 tech_{it} + FE_p + FE_i + FE_t + \epsilon_{ipt} 
\end{equation}
...
The interaction term $tech_{it} \cdot category_{p}$ captures the relationship between technology adoption and trade outcomes for products of a specific category.
...
source("../Indonesia/05_regressions_product_model_lagged_IDN.R", chdir = TRUE)
...
# Run regressions for products model for Indonesia 
source("../Indonesia/06_regressions_tech_mitigation_covid_IDN.R", chdir = TRUE)
...
models_tech_covid_ebay_china_IDN[[2]]
...
models_covid_time_sensitivity_IDN[[2]]
...
models_covid_prods_impacted_IDN[[2]]
...
models_covid_prods_cap_int_IDN[[2]]
...
results_mod1<-readRDS("../../Outputs/Indonesia/regressions_results/products_model/extensive_margin_results_mod1_IDN.rds")

results_mod1_n_countries<-readRDS("../../Outputs/Indonesia/regressions_results/products_model/extensive_margin_results_mod1_n_countries_IDN.rds")
...
# results_mod1[[16]][[1]]  # Was not able to be estimated not variability in variable agric_timesensitive
...
results_mod2<-readRDS("../../Outputs/Indonesia/regressions_results/tech_mitigation_covid_model/extensive_margin_results_mod2_IDN.rds")

results_mod2_n_countries<-readRDS("../../Outputs/Indonesia/regressions_results/tech_mitigation_covid_model/extensive_margin_results_mod2_n_countries_IDN.rds")
