...
# Read Mexico data at the firm-month level for regression that measures if tech adoption mitigated covid impacts ----
import_tech_mitig<-fread("../../Data/Mexico/processed_data/imports_tech_mitigation_reg_firm_month_MEX.csv")
export_tech_mitig<-fread("../../Data/Mexico/processed_data/exports_tech_mitigation_reg_firm_month_MEX.csv")
...
reg_firm_month_tech_covid_mitig_MEX<-reg_firm_month_tech_covid_mitig(import_data = import_tech_mitig, 
