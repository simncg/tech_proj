  ...
  mutate(
    adopter_type = 
      case_when(
        ...
        is.na(date_of_adoption) | year(date_of_adoption) == 2022  ~ "never_adopter"  # Never adopters during our period of analysis (since 2022 is outside our period of analysis we set those firms that adopt the technology in 2022 as never adopters)
      ), 
    ...
    old_adopter_type = 
      case_when(
        ...
        # Never adopters 
        is.na(date_of_adoption) | year(date_of_adoption) == 2022 ~ "never_adopter",  # Never adopters during our period of analysis
