...
# Run extensive margin regressions using as independent variables different types of pre-2019 adopter (pre-2017 adopter, 2017 adopter and 2018 adopter)
models_prop_pre_2019_adopters_MEX<-prop_reg_models_pre_2019_adopters(country_name = "Mexico",
