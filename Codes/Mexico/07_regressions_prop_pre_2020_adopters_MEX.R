...
# Run extensive margin regressions using as independent variables different types of pre-2019 adopter (pre-2017 adopter, 2017 adopter, 2018 adopter and 2019 adopter)
models_prop_pre_2020_adopters_MEX<-prop_reg_models_pre_2020_adopters(country_name = "Mexico",
