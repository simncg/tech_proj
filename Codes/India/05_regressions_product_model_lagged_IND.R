...
pay_ecom_import_data_IND[ebay_china_vars] <- lapply(pay_ecom_import_data_IND[ebay_china_vars], function(x) 1 * x)
pay_ecom_export_data_IND[ebay_china_vars] <- lapply(pay_ecom_export_data_IND[ebay_china_vars], function(x) 1 * x)
...
models_ebay_china_IND_t_1 <- reg_models_ebay_china(tech_var = "pay_or_ecomnod_t_1", 
...
models_ebay_china_IND_t_2 <- reg_models_ebay_china("pay_or_ecomnod_t_2", 
                                                   import_data = pay_ecom_import_data_IND,
                                                   export_data = pay_ecom_export_data_IND, 
                                                   coef_labels = coef_labels, 
                                                   country_name = "India")
...
models_ebay_china_IND_t_3 <- reg_models_ebay_china("pay_or_ecomnod_t_3", 
                                                   import_data = pay_ecom_import_data_IND,
                                                   export_data = pay_ecom_export_data_IND, 
                                                   coef_labels = coef_labels, 
                                                   country_name = "India")
...
pay_ecom_import_data_IND[bec_vars] <- lapply(pay_ecom_import_data_IND[bec_vars], function(x) 1 * x)
pay_ecom_export_data_IND[bec_vars] <- lapply(pay_ecom_export_data_IND[bec_vars], function(x) 1 * x)
...
# Regressions with 1 lag (t-1) in technology variable
models_BEC_IND_t_1 <- reg_models_BEC("pay_or_ecomnod_t_1", 
                                     import_data = pay_ecom_import_data_IND,
                                     export_data = pay_ecom_export_data_IND, 
                                     coef_labels = coef_labels, 
                                     country_name = "India")
...
# Regressions with 2 lags (t-2) in technology variable
models_BEC_IND_t_2 <- reg_models_BEC("pay_or_ecomnod_t_2", 
                                     import_data = pay_ecom_import_data_IND,
                                     export_data = pay_ecom_export_data_IND, 
                                     coef_labels = coef_labels, 
                                     country_name = "India")
...
# Regressions with 3 lags (t-3) in technology variable
models_BEC_IND_t_3 <- reg_models_BEC("pay_or_ecomnod_t_3", 
                                     import_data = pay_ecom_import_data_IND,
                                     export_data = pay_ecom_export_data_IND, 
                                     coef_labels = coef_labels, 
                                     country_name = "India")
...
pay_ecom_import_data_IND[time_sens_vars] <- lapply(pay_ecom_import_data_IND[time_sens_vars], function(x) 1 * x)
pay_ecom_export_data_IND[time_sens_vars] <- lapply(pay_ecom_export_data_IND[time_sens_vars], function(x) 1 * x)
...
# Regressions with 1 lag (t-1) in technology variable
models_time_sens_IND_t_1 <- reg_models_time_sens("pay_or_ecomnod_t_1", 
                                                 import_data = pay_ecom_import_data_IND,
                                                 export_data = pay_ecom_export_data_IND, 
                                                 coef_labels = coef_labels, 
                                                 country_name = "India")
...
# Regressions with 2 lags (t-2) in technology variable
models_time_sens_IND_t_2 <- reg_models_time_sens("pay_or_ecomnod_t_2", 
                                                 import_data = pay_ecom_import_data_IND,
                                                 export_data = pay_ecom_export_data_IND, 
                                                 coef_labels = coef_labels, 
                                                 country_name = "India")
...
# Regressions with 3 lags (t-3) in technology variable
models_time_sens_IND_t_3 <- reg_models_time_sens("pay_or_ecomnod_t_3", 
                                                 import_data = pay_ecom_import_data_IND,
                                                 export_data = pay_ecom_export_data_IND, 
                                                 coef_labels = coef_labels, 
                                                 country_name = "India")
...
# Regressions with 1 lag (t-1) in technology variable
models_other_HS_IND_t_1 <- reg_models_other_HS("pay_or_ecomnod_t_1", 
                                               import_data = pay_ecom_import_data_IND,
                                               export_data = pay_ecom_export_data_IND, 
                                               coef_labels = coef_labels, 
                                               country_name = "India")
...
# Regressions with 2 lags (t-2) in technology variable
models_other_HS_IND_t_2 <- reg_models_other_HS("pay_or_ecomnod_t_2", 
                                               import_data = pay_ecom_import_data_IND,
                                               export_data = pay_ecom_export_data_IND, 
                                               coef_labels = coef_labels, 
                                               country_name = "India")
...
# Regressions with 3 lags (t-3) in technology variable
models_other_HS_IND_t_3 <- reg_models_other_HS("pay_or_ecomnod_t_3", 
                                               import_data = pay_ecom_import_data_IND,
                                               export_data = pay_ecom_export_data_IND, 
                                               coef_labels = coef_labels, 
                                               country_name = "India")
...
pay_ecom_import_data_IND[cap_int_vars] <- lapply(pay_ecom_import_data_IND[cap_int_vars], function(x) 1 * x)
pay_ecom_export_data_IND[cap_int_vars] <- lapply(pay_ecom_export_data_IND[cap_int_vars], function(x) 1 * x)
...
# Regressions with 1 lag (t-1) in technology variable
models_cap_int_IND_t_1 <- reg_models_cap_int("pay_or_ecomnod_t_1", 
                                             import_data = pay_ecom_import_data_IND,
                                             export_data = pay_ecom_export_data_IND, 
                                             coef_labels = coef_labels, 
                                             country_name = "India")
...
# Regressions with 2 lags (t-2) in technology variable
models_cap_int_IND_t_2 <- reg_models_cap_int("pay_or_ecomnod_t_2", 
                                             import_data = pay_ecom_import_data_IND,
                                             export_data = pay_ecom_export_data_IND, 
                                             coef_labels = coef_labels, 
                                             country_name = "India")
...
# Regressions with 3 lags (t-3) in technology variable
models_cap_int_IND_t_3 <- reg_models_cap_int("pay_or_ecomnod_t_3", 
                                             import_data = pay_ecom_import_data_IND,
                                             export_data = pay_ecom_export_data_IND, 
                                             coef_labels = coef_labels, 
                                             country_name = "India")
