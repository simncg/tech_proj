...
# 2.	They are going to be firms in the new file that are not in the old file. Create a dummy for them. We will want to know what share of trade they account for. 
# 
# How many firms are? If they are few we can find the websites manually. 
# 
# Trade value by year of the firms that are in the new file but not in the old file. 
# 
...
write_dta(corresp_table, "../../Data/India/processed_data/correspondence_table_complete_IND.dta")
...
write_csv(cases_for_fuzzy, "../../Data/India/processed_data/new_ids_cases_for_fuzzy_builtwith_IND.csv")
...
# Save in dta
write_dta(aberdeen_data, "../../Data/India/processed_data/old_ids_new_ids_aberdeen_names_IND.dta")

# Save in dta
write_dta(same_new_id_diff_old_ids_aberdeen, "../../Data/India/processed_data/new_ids_with_multiple_old_ids_aberdeen_names_IND.dta")
...
write_csv(cases_for_fuzzy_aberdeen, "../../Data/India/processed_data/new_ids_cases_for_fuzzy_aberdeen_IND.csv")
...
write.csv(one_aberdeen_name_matched, "../../Data/India/processed_data/one_aberdeen_name_matched_cases_for_fuzzy_IND.csv")
