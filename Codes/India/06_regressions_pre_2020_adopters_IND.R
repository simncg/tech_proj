...
# is never adopter/covid-adopter and if it is pre-2020 adopter the variable will be equal 
...
import_tech_mitig<-data.frame(import_tech_mitig, i(import_tech_mitig$pre_2020_adopter_type, ref = "non_pre_2020_adopter")) %>% 
  rename(`pre_2017_adopter` = `X2016_or_pre_2016_adopter`, 
         `adopter_2017` = `X2017_adopter`, 
         `adopter_2018` = `X2018_adopter`, 
         `adopter_2019` = `X2019_adopter`
...
# Run log.import and log. export regressions using as independent variables pre-2017 adopter, 2017-adopter, 2018-adopter and 2019-adopter
pre_2020_adopters_reg_imp_exp_IND<- reg_models_pre_2020_adopters(import_data = import_tech_mitig, 
...
# Run no. destinations/sources regressions using as independent variables pre-2017 adopter, 2017-adopter, 2018-adopter and 2019-adopter
pre_2020_adopters_reg_n_countries_IND<- reg_models_pre_2020_adopters(import_data = import_tech_mitig, 
                                                                 export_data = export_tech_mitig, 
                                                                 country_name = "India", 
                                                                 product_vars = c("cons_BEC", 'China_E_commerce', "Ebay_tradable", "durable_BEC"), 
                                                                 coef_labels = coef_labels, 
...
pre_2020_adopters_reg_source_dest_IND<- reg_models_pre_2020_adopters(import_data = import_tech_mitig, 
                                                                     export_data = export_tech_mitig, 
                                                                     country_name = "India", 
                                                                     product_vars = c("cons_BEC", 'China_E_commerce', "Ebay_tradable", "durable_BEC"), 
                                                                     coef_labels = coef_labels, 
