...
foreach y of local dep_vars {
	...
	* Creating tex file with the table for first stage
	cap file close fh 
	file open fh using "$path_outputs/India/regressions_results/firm_month_model/first_stage_log_iv_`y'_firm_month.tex", write replace  // Opening latex file for first stage
...
foreach y of local dep_vars {
	...
	* Creating tex file with the table for first stage
	cap file close fh 
	file open fh using "$path_outputs/India/regressions_results/firm_month_model/second_stage_log_iv_`y'_firm_month.tex", write replace  // Opening latex file for first stage
