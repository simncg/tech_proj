...
#                                                                           #
# Script:  This script runs the extensive margin regressions for India      #
...
# AJUSTAR LABELS EN COEF_LABELS

models_tech_covid_definitive_months_adopted_IND<-prop_reg_models_2019_tech_var_months_covid("India", 
                                                                                            coef_labels)
