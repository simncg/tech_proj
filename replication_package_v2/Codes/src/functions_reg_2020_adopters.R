...
# Function for running extensive margin regressions using different type of pre-2020 adopters as independent variables (pre-2017 adopter, 2017-adopter, 2018-adopter, 2019-adopter)
